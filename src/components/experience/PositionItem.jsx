    ...
    <div className='positionItem mb-2 mx-2 rounded-md card bg-gray-800'>
        <div className='card-body w-full ml-0 inline'>
            <h3 className='mb-2 text-xl font-semibold'>
                <div className='mr-2 h-8 badge badge-warning badge-xlg'>
                    <FaIdBadge className='inline' /> {position}
                </div>
            </h3>
            <div className='mr-3 mt-2 h-8 badge badge-info badge-xlg'>
                    <FaBuilding className='inline' /> {employer}
             </div>
            <div className='mr-2 mt-3 h-8 badge badge-success badge-xlg'>
